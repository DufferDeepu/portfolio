...
const Button = () => {
  return (
        <div className='flex flex-row justify-start items-center gap-2 w-full'>
          ...
          <button className="flex items-center justify-center px-6 py-4 text-sm bg-green-100 text-green-800 rounded-4xl border-none transition-all duration-200 flex-shrink-0">
