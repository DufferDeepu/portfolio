      ...
      <ul className="mx-auto w-full gap-4">
        {cards.map((card, index) => (
          <motion.div
            ...
            className="p-4 flex flex-row justify-between items-center hover:bg-neutral-800/90 dark:hover:bg-neutral-100/90 rounded-xl cursor-pointer"
          >
            <div className="flex gap-4 flex-row">
              ...
              <div className="">
                <motion.h3
                  ...
                  className="font-medium text-neutral-300/90 dark:text-neutral-400 text-left"
                >
                  {card.title}
                </motion.h3>
                <motion.p
