      ...
      <ul className="max-w-2xl mx-auto w-full gap-4">
        {cards.map((card, index) => (
          <motion.div
            ...
            className="p-4 flex flex-col md:flex-row justify-between items-center hover:bg-neutral-800/90 dark:hover:bg-neutral-100/90 rounded-xl cursor-pointer"
          >
            <div className="flex gap-4 flex-col md:flex-row ">
              ...
              <div className="">
                <motion.h3
                  ...
                  className="font-medium text-neutral-300/90 dark:text-neutral-400 text-center md:text-left"
                >
                  {card.title}
                </motion.h3>
                <motion.p
            ...
            <motion.button
              ...
              className="px-3 py-2 text-sm rounded-full font-bold flex items-center justify-start gap-2.5 
      text-white transition duration-300 ease-in-out bg-neutral-900/90 hover:bg-neutral-800/90
      group"
            >
              <GithubIcon />
            </motion.button>
...
const cards = [
  {
    ...
    src: "project1.svg",
    ctaText: "",
    ctaLink: "https://github.com/DufferDeepu/Coreco",
    content: () => {
      return (
        <p>
  ...
  },
  {
    ...
    src: "project2.png",
    ctaText: "",
    ctaLink: "https://second-brain-nine-teal.vercel.app/",
    content: () => {
      return (
        <p>
          Built a personal knowledge management app to store and organize tweets, YouTube videos, documents, notes, and
          web links in one place.
          Developed a Vite.js frontend and Node.js + Express backend with MongoDB (Mongoose) for efficient data storage
          and retrieval.
        </p>
      );
    },
...

  {
    ...
    src: "project3.ico",
    ctaText: "",
    ctaLink: "https://crate-drab.vercel.app/",
    content: () => {
      return (
        <p>
          Built a wallet tool supporting new wallet generation and seed phrases.
          Implemented features to display and copy public/private keys securely, with a clean Next.js + Shadcn UI.
        </p>
      );
    },
  },
